...
namespace ViesApi
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="urn:ec.europa.eu:taxud:vies:services:checkVat", ConfigurationName="ViesApi.checkVatPortType")]
    public interface checkVatPortType
    {
        ...
        System.Threading.Tasks.Task<ViesApi.checkVatResponse> checkVatAsync(ViesApi.checkVatRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<ViesApi.checkVatApproxResponse> checkVatApproxAsync(ViesApi.checkVatApproxRequest request);
    }
    ...
    public partial class checkVatApproxResponse
    {
        ...
        public checkVatApproxResponse(
                    ...
                    string traderCity, 
                    ViesApi.matchCode traderNameMatch, 
                    ViesApi.matchCode traderCompanyTypeMatch, 
                    ViesApi.matchCode traderStreetMatch, 
                    ViesApi.matchCode traderPostcodeMatch, 
                    ViesApi.matchCode traderCityMatch, 
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    public interface checkVatPortTypeChannel : ViesApi.checkVatPortType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    public partial class checkVatPortTypeClient : System.ServiceModel.ClientBase<ViesApi.checkVatPortType>, ViesApi.checkVatPortType
    {
        ...
        public System.Threading.Tasks.Task<ViesApi.checkVatResponse> checkVatAsync(ViesApi.checkVatRequest request)
        {
            return base.Channel.checkVatAsync(request);
        }
        
        public System.Threading.Tasks.Task<ViesApi.checkVatApproxResponse> checkVatApproxAsync(ViesApi.checkVatApproxRequest request)
        {
